  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#F4F5F7' }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ width: 40, height: 40, border: '4px solid #DFE1E6', borderTopColor: '#0079BF', borderRadius: '50%', animation: 'spin .7s linear infinite', margin: '0 auto 16px' }} />
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/boards" element={<PrivateRoute><DashboardPage /></PrivateRoute>} />
